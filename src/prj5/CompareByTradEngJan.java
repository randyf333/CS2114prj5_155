...
// -------------------------------------------------------------------------
/**
 * Comparator object to compare two Influencer objects by Jan
 * 
 * @author randy
 * @version Dec 1, 2023
 */
public class CompareByTradEngJan
    implements Comparator<Influencer>
{
    ...
    {
        return (int)i1.getTradEngagement(1, 1)
            - (int)i2.getTradEngagement(1, 1);
    }
