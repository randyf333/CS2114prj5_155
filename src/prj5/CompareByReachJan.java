...
// -------------------------------------------------------------------------
/**
 * Comparator object to compare two Influencer objects by Quarter
 * 
 * @author randy
 * @version Dec 1, 2023
 */
public class CompareByReachJan
    implements Comparator<Influencer>
{
    ...
    {
        return (int)i1.getReachEngagement(1, 1)
            - (int)i2.getReachEngagement(1, 1);
    }
